...
const ShopOwnerEditProfile = ({navigation}) => {
  ...
  const [cnic, setcnic] = useState(userdetails?.cnic);
              ...
              <View style={{marginTop: 20}}>
                ...
                <View style={{backgroundColor: 'white', marginTop: 20}}>
                  ...
                  <TextInput
                    ...
                    onChangeText={val => settelephonenumber(val)}
                  />

                  <TextInput
                    style={styles.inputText}
                    placeholder={userdetails?.permanentaddress}
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={Font.LightColor}
                    keyboardType="numeric"
                    placeholder={userdetails?.cnic.toString()}
